...
请按照以下要求完成分析：
1.先梳理阅读文本的核心信息（如主要内容、中心思想、关键细节、作者观点等），再对比学生作答与文本的偏差，明确指出错误类型（如信息提取错误、理解偏差、逻辑推理错误、概括不全面等），并说明错误的具体表现，最后给出建议答案，避免表格形式。
2. 针对错误根源提供至少2条具体、可操作的提升建议，建议需结合阅读理解的常见技巧（如定位关键词、分析段落结构、归纳中心思想等），避免空泛表述。

请确保分析全面、建议实用，帮助学生明确改进方向。
`;